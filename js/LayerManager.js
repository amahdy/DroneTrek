...
define(function () {
    ...
    var LayerManager = function (worldWindow) {
        ...
        $("#orderButton").on("click", function(e) {
          var projectionName = $('#projectionDropdown').find("button").text();
          // $("#projectionDropdown").find("button").html(projectionName + ' <span class="caret"></span>');
          $('#successMessage').show();
          if(projectionName === "Water Sample + Image Analysis ") {
            $("#orderType").html("Water Sample + Image Analysis");
          }else {
            $("#orderType").html("Image Analysis Only");
          }
        });

        $("#plButton").on("click", function(e) {
          $("#globe").addClass("placemarks");
        });
    ...
    LayerManager.prototype.onProjectionClick = function (event) {
        ...
        $("#projectionDropdown").find("button").html(projectionName + ' <span class="caret"></span>');
        $('#successMessage').hide();
        $("#globe").removeClass("placemarks");
        $("#orderButton").prop('disabled', false);

        // if(projectionName === "Water Sample + Image Analysis") {
        //   alert("Order for 'Water Sample + Image Analysis' received!");
        // }else {
        //   alert("Order for 'Image Analysis Only' received!");
        // }
    ...
    LayerManager.prototype.createProjectionList = function () {
        ...
        var dropdownButton = $('<button class="btn btn-info btn-block dropdown-toggle" type="button" data-toggle="dropdown">Nothing Selected<span class="caret"></span></button>');
